...
shellcmd xsh_cat(int, char *p[]);
shellcmd xsh_ls(int, char *p[]);
shellcmd xsh_rm(int, char *p[]);
shellcmd xsh_touch(int, char *p[]);
shellcmd xsh_mkdir(int, char *p[]);
shellcmd xsh_cp(int, char *p[]);
shellcmd xsh_mv(int, char *p[]);
shellcmd xsh_rmdir(int, char *p[]);
shellcmd xsh_pwd(int, char *p[]);
shellcmd xsh_cd(int, char *p[]);
